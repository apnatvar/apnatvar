...
##### 7. https://github.com/apnatvar/Computer-Networking.git - Computer Networking Module at Trinity College Dublin, Semester 2, Year 3. This involves Project 1 (Solo) and a Project 2 (Group) both written entirely in Python. For the latter, we went forward majorly with what I worked on in Project 1. The overall structure remains similar with improvements in multithreading, sending/recieving fsm. A database was also downloaded where queries can be run using SQL commands in Python. 
<!---
